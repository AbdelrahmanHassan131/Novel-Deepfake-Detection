"""
Multi-Head Attention Fusion WWXC Trainer (MHA_WWXC).
...
from .mha_wwxc_classifier import MHAFusionWWXCClassifier


class MHAFusionWWXCTrainer(BaseModel):
    """
    Trainer for 4-model MHA Fusion (WWXC).
    ...
    def __init__(self, opt):
        super(MHAFusionWWXCTrainer, self).__init__(opt)
        ...
        if self.isTrain and not opt.continue_train:
            self.model = MHAFusionWWXCClassifier(
        ...
        print(f"MHA_WWXC model created with {self.fusion_type} fusion")
